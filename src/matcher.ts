...
export interface MatchedRoute {
  ...
  path: string
  /**
   * Key-value pairs of route dynamic segments and wildcards. Access wildcard
   * values with the 'wild' key.
   */
...
interface RouteMatchData {
  ...
  path: string
  /** The pattern generated by regexparam */
  pattern: RegExp
  /** The keys the pattern will match to */
  keys: string[]
